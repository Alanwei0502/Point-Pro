...
import { SpecialtyItem, Specialty, Order } from "~/features/orders/type";
import { postOrder, setMobileOrderStatusTab } from "~/app/slices/order.slice";
import { MOBILE_ORDER_STATUS_TAB, ORDER_STATUS } from "~/utils/constants.utils";
import { calculateCartItemPrice, calculateCartPrice, calculateOrderPrice } from "~/utils/price.utils";
import { CustomerBookingDialog, MobileModal, OrderStatus, OrderType, DialogType } from "~/types/common";
