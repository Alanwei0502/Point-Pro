import { OrderStatus, SpecialtyType, OrderStatusTitle, Gender, SeatStatus } from "~/types";

// 專門放固定參數
export const genderList = [
  { id: Gender.MALE, title: "先生" },
  { id: Gender.FEMALE, title: "小姐" },
  { id: Gender.OTHER, title: "其他" }
];
