...
import { appDayjs, seatStatusListObj, formatTimeOnly, GENDER_TRANSLATE } from '~/utils';

import { useAppDispatch } from '~/hooks';
import { patchReservation, getUserTokenByReservationLogId, setDialog } from '~/store/slices';
...
//     {
//       label: '姓名',
//       value: info?.reservation?.options.name + GENDER_TRANSLATE[info?.reservation?.options.gender],
//     },
//     {
//       label: '總人數',
