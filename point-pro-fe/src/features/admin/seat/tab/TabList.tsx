...
import { appDayjs, formatTimeOnly, genderObj, reservationStatusListObj } from '~/utils';
import { headerHeight } from '~/components';
import { Gender, ReservationInfo, ReservationMessage } from '~/types';
...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    valueFormatter: (params: GridValueFormatterParams<{ name: string; gender: Gender }>) => {
      const { name, gender } = params.value;
      return name + genderObj[gender];
    },
  },
