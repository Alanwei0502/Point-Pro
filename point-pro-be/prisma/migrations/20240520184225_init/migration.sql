...
-- CreateEnum
CREATE TYPE "login_type" AS ENUM ('LOGIN', 'LOGOUT');
...
CREATE TABLE "login_logs" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "log_type" "login_type" NOT NULL DEFAULT 'LOGIN',
    "operation_time" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "order_meals" (
    ...
    "served_amount" SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE "reservations" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "type" "reservation_type" NOT NULL DEFAULT 'ONLINE',
...
-- AddForeignKey
ALTER TABLE "meal_specialties" ADD CONSTRAINT "meal_specialties_meal_id_fkey" FOREIGN KEY ("meal_id") REFERENCES "meals"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "meal_specialties" ADD CONSTRAINT "meal_specialties_specialty_id_fkey" FOREIGN KEY ("specialty_id") REFERENCES "specialties"("id") ON DELETE CASCADE ON UPDATE CASCADE;
